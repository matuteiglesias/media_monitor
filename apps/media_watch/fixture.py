...
def seed(root: Path) -> None:
    ...
    rows = [
        MediaObservation("el-destape-youtube", "fixtureA01", "Economía y actualidad — Carlos Melconian", "00:00 Apertura\n05:00 Entrevista económica\n15:00 Cierre", "2026-08-30T19:00:00Z", 1260, 1200, 90, 14, "public", "2026-08-30T20:00:00Z"),
        MediaObservation("el-destape-youtube", "fixtureA02", "Programa completo de la tarde", "Emisión completa.", "2026-08-30T17:00:00Z", 7200, 2400, 110, 20, "public", "2026-08-30T20:00:00Z"),
        MediaObservation("futurock-youtube", "fixtureB01", "Análisis económico del día con Marina Dal Poggetto", "Clip editorial.", "2026-08-30T18:30:00Z", 980, 1800, 130, 30, "public", "2026-08-30T20:00:00Z"),
        MediaObservation("futurock-youtube", "fixtureB02", "Mañana de radio — programa", "00:00 Inicio\n42:10 Columna económica\n58:30 Noticias", "2026-08-30T14:00:00Z", 6400, 3000, 155, 41, "public", "2026-08-30T20:00:00Z"),
    ]
